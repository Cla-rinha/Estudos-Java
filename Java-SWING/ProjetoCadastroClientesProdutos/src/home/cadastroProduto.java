...
public class cadastroProduto extends JFrame{
    private JTextField idPoduto, nomeProduto, precoUnitarioProduto, precoLoteProduto, custoProducaoProduto, categoriaProduto, fornecedorProduto, descricaoProduto;
    ...
    public cadastroProduto(){
        ...
        painelProduto.setBorder(BorderFactory.createEmptyBorder(15, 15, 15, 15));
        ...
        adicionarComponente(painelProduto, c, 1, "ID:", idPoduto, "Nome:", nomeProduto);
        adicionarComponente(painelProduto, c, 2, "Preço unitário:", precoUnitarioProduto, "Preço do lote: ", precoLoteProduto);
        adicionarComponente(painelProduto, c, 4, "Custo de produção:", custoProducaoProduto, "Categoria", categoriaProduto);
        adicionarComponente(painelProduto, c, 6, "Tamanho do produto:", tamanhoProduto, "Fornecedor:", fornecedorProduto);
        ...
        this.setVisible(true);
          ...
          public void adicionarComponente(JPanel painelProduto, GridBagConstraints c, int linha, String labelText, JComponent campo, String labeltext2, JComponent campo2){
            c.gridx = 0;
        ...
        public void cadastrarProduto(){
            ...
            produto.setIdProd(Integer.parseInt(idPoduto.getText()));
